...
# Sounds
jump_snd = load_sound('assets/sounds/unknown.ogg')
gem_snd = load_sound('assets/sounds/carrot.ogg')
hurt_snd = load_sound('assets/sounds/hurt.ogg')
win_snd = load_sound('assets/sounds/win.ogg')
power_snd = load_sound('assets/sounds/powerup.ogg')

start_theme = load_sound('assets/sounds/funny_music.ogg')


# Images
idle = load_image('assets/PNG/Players/bunny2_stand3.png')
walk = [load_image('assets/PNG/Players/bunny2_walk12.png'),
        load_image('assets/PNG/Players/bunny2_walk21.png')]
jump = load_image('assets/PNG/Players/bunny2_jump2.png')
hurt = load_image('assets/PNG/Players/bunny2_hurt2.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/cotton_candy.png'),
                "Dirt": load_image('assets/images/tiles/platformPack_tile007.png'),
                "Platform": load_image('assets/images/tiles/platformPack_tile6969.png'),
                "Plant": load_image('assets/images/items/candy_cane.png'),
                "FlagTop": load_image('assets/images/tiles/medievalTile_1661.png'),
                "FlagPole": load_image('assets/images/tiles/medievalTile_190.png'),
                "Oceanfloor": load_image('assets/images/tiles/platformPack_tile016.png'),
                "Oceanplatform": load_image('assets/images/tiles/platformPack_tile007.png')}
        
basic_enemy_images = [ load_image('assets/PNG/Enemies/spikeBall1.png'),
                       load_image('assets/PNG/Enemies/spikeBall_2.png') ]

platform_enemy_images = [ load_image('assets/PNG/Enemies/spikeMan_walk1.png'),
                          load_image('assets/PNG/Enemies/spikeMan_walk2.png') ] 

item_images = { "Gem": load_image('assets/PNG/HUD/carrots.png'),
                "Powerup": load_image('assets/images/tiles/candy_plant.png')}
    ...
    def load_items(self):
        ...
        for element in self.map_data['items']:
            ...
            if kind == "Gem":
                ...
                s = Powerup(x, y, item_images[kind])
...
class Game():
    ...
    def show_title_screen(self):
        ...
        text = font_xl.render(TITLE, 1, PINK)
        rect = text.get_rect()
    ...
    def show_cleared_screen(self):
        text = font_lg.render("Level cleared", 1, YELLOW)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 144
        screen.blit(text, rect)
    ...
    def show_win_screen(self):
        ...
        text = font_lg.render("You win", 1, YELLOW)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 212
        screen.blit(text, rect)

        text = font_sm.render("Press space to play again!", 1, YELLOW)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_pause_screen(self):
        text = font_lg.render("PAUSE", 1, YELLOW)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 212
        screen.blit(text, rect)

        text = font_sm.render("Press p to play", 1, YELLOW)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_lose_screen(self):
        screen.fill(BOO_BLUE)
        
        text = font_xl.render("You lose", 1, LOSER_PINK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 212
        screen.blit(text, rect)

        text = font_sm.render("Press space to play again!", 1, LOSER_PINK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
